export const config = {
  "mapTitle": "map-inflation-october", // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
  "vercelURL": "map-inflation-october.vercel.app", // The url provided when deploying the map on Vercel
